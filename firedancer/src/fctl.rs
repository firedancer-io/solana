...
pub fn housekeeping_default_interval_nanos(cr_max: u64) -> i64 {
  unsafe { tango::fd_tempo_lazy_default(cr_max) }
}

pub fn minimum_housekeeping_tick_interval(lazy: i64) -> u64 {
  unsafe { tango::fd_tempo_async_min(lazy, 1, tango::fd_tempo_tick_per_ns(null_mut()) as f32) }
}
