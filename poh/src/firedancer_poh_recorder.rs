...
extern "C" {
    fn fd_ext_poh_initialize(hashcnt_duration_nanos: f64, hashcnt_per_tick: u64, ticks_per_slot: u64, tick_height: u64, last_entry_hash: *const u8, signal_leader_change: *mut c_void);
...
impl PohRecorder {
    ...
    pub fn new_with_clear_signal(
        ...
        let hash_duration_nanos: f64 = poh_config.target_tick_duration.as_nanos() as f64 / poh_config.hashes_per_tick.unwrap_or(1) as f64;
