...
mod tests {
    ...
    fn test_allocate() {
        ...
        process_instruction(
            ...
            vec![(alice_pubkey, alice_account.clone())],
            vec![
                AccountMeta {
                    pubkey: alice_pubkey,
                    is_signer: true,
    ...
    fn test_allocate_with_seed() {
        ...
        process_instruction(
            &bincode::serialize(&SystemInstruction::AllocateWithSeed { base: base_pubkey, seed: seed.to_string(),  space: 2 as u64,  owner: owner}).unwrap(),
        ...
        process_instruction(
            &bincode::serialize(&SystemInstruction::AllocateWithSeed { base: base_pubkey, seed: seed.to_string(),  space: 2 as u64,  owner: owner}).unwrap(),
            vec![
                (alice_with_seed.clone(), alice_account.clone()),
        ...
        let alien_account = AccountSharedData::new(100, 0, &Pubkey::new_unique());
        process_instruction(
            &bincode::serialize(&SystemInstruction::AllocateWithSeed { base: base_pubkey, seed: seed.to_string(),  space: 2 as u64,  owner: owner}).unwrap(),
            vec![
                (alice_with_seed.clone(), alien_account.clone()),
                (base_pubkey.clone(), alice_account.clone())
            ],
            vec![
                AccountMeta {
        ...
        let no_account = AccountSharedData::new(0, 0, &system_program::id());
        process_instruction(
            &bincode::serialize(&SystemInstruction::AllocateWithSeed { base: base_pubkey, seed: seed.to_string(),  space: 2 as u64,  owner: owner}).unwrap(),
            vec![
                (alice_with_seed.clone(), no_account.clone()),
                (base_pubkey.clone(), alice_account.clone())
            ],
            vec![
                AccountMeta {
